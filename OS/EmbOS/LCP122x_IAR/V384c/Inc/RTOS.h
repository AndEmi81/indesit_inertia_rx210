...
/* System Alarm */
#define   OS_PSSYSALM       (16)
#ifndef   OS_PCLK_ALM                                 /* Peripheral clock for system alarm   */
  #define OS_PCLK_ALM       (OS_FSYS/OS_PSSYSALM)     /* May vary from CPU clock      */
#endif                                                /* depending on CPU             */
/* System Timer */
#define   OS_PSSYS          (1)
#ifndef   OS_PCLK_TIMER                               /* Peripheral clock for timer   */
  #define OS_PCLK_TIMER     (OS_FSYS/OS_PSSYS)        /* May vary from CPU clock      */
#endif                                                /* depending on CPU             */
...
#define OS_VERSION_GENERIC (38403)       /*   Generic version 3.84c */
