...
#define OS_VERSION_GENERIC (38216)       /*   Generic version 3.82p */
...
struct OS_alarm {
  ...
  char    Active;                   /*  0 :   inactive
                                        1 :   active 
                                    */
  char    ActivationsCount;        /* counter before became inactive */
#if OS_DEBUG
  char Id;
#endif
};
...
\li alarm was created by OS_CreateAlarm()
*/
void OS_SetAlarmActivationsCount_(OS_ALARM* pAlarm, char ActivationsCount);
