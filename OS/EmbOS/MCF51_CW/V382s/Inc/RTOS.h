...
/*********************************************************************
*
*     Specifics for Coldfire V1 cores and Codewarrior compiler
*
**********************************************************************
*/
...
*/
#define OS_FSYS         (39845888uL)         /* */
#define OS_PSSYS        (0x03)              /* System counter prescaler code  (used for register configuration)*/
#define OS_SYSTEM_PS    (1<<OS_PSSYS)       /* System counter prescaler value */


#ifndef   OS_PCLK_TIMER
  #define OS_PCLK_TIMER  ((OS_FSYS/2)/OS_SYSTEM_PS)
#endif
...
#define   OS_FIRST_VECTOR_NUMBER          (VectorNumber_Virq)

#define   OS_VECTOR(vectornumber)         (vectornumber - OS_FIRST_VECTOR_NUMBER)
...
#define OS_PTR_OP_IS_ATOMIC       (0)             // To be verified, disabled to be safe
#define OS_U32_OP_IS_ATOMIC       (0)             // To be verified, disabled to be safe
...
#define OS_SUPPORT_INTSTACK_INFO            (0)   // separate INTSTACK not used
...
#define OS_CPU "ColdFireV1"
#define OS_DI() {     OS_DisableNMI(); OS_DisableInt();  }
#define OS_EI() {     OS_EnableInt();  OS_EnableNMI();   }

/* OS_EnterIntStack(), OS_LeaveIntStack() */
...
typedef struct {  // xxx Dummy for the moment...
  OS_U32 PC;
} OS_REGS_EXT;
...
void OS_EnableInt(void);     /* Helper functionn, RTOS.s            */
void OS_DisableInt(void);    /* Helper functionn, RTOS.s            */
void OS_ISR_Handler(void);   /* Low level interrupt handler, RTOS.s */
unsigned long OS_GetPC(void);
...
#define OS_VERSION_GENERIC (38219)       /*   Generic version 3.82s */
...
#define OS_MAX_ALARMcyc                       ((0xFFFF*OS_PCLK_TIMER/1000000))
#define OS_MAX_ALARMus                        (((0xFFFF*1000000.0)/OS_PCLK_TIMER))
