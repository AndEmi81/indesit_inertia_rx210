...
#define OS_GetTime()              ((OS_TIME)OS_Time)
...
#define OS_PCLK_ALM       		(OS_FSYS/OS_PSSYS)	/* May vary from CPU clock      */
#endif
...
#define OS_VERSION_GENERIC (38224)       /*   Generic version 3.82x */
...
#define OS_MAX_ALARMcyc                       ((0xFFFF*OS_PCLK_ALM / 1000000))
#define OS_MAX_ALARMus                        (((0xFFFF*1000000.0) / OS_PCLK_ALM))
/*
