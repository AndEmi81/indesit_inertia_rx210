...
#define BUS_COM_PLT_BUF_SIZE_UART			(80)
...
void Get_Digital_Protocol_Status_Addr_dim (uint8_t v);
void Get_Digital_Protocol_Status_Var_dim (uint8_t v);
void Get_Digital_Protocol_UIInfoBuff_dim (uint8_t v);
