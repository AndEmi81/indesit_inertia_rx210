...
uint8_t DP_Status_Var_dim = 0;
uint8_t DP_Reg_Var_dim = 0;
uint8_t DP_UIInfoBuff_dim = 0;
#pragma section
/* Exported */
...
uint8_t Digital_Protocol_Get_UI_Info_Ctrl(void)
{
	return UI_Info_Ctrl;
}

void Digital_Protocol_Set_UI_Info_Ctrl(uint8_t value)
{
	UI_Info_Ctrl = value;
}
/* *********** */
