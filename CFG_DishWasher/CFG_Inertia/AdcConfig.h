...
/* 
Statistics: # times V Line Over and Under Threshold. 
*/
#define CHECK_VLINE_CROSSING    FALSE
/* 
...
*/
#define ADC_CONV_FREQUENCY_Hz	(1245184)
/*
...
*/
#define ADC_NUM_CHANNELLS_USED				CONFIG_ADC_DRV_CHANNELS_NUM
/*
...
#define VLINEMEASURE_COMP_FACTOR        	CONFIG_VLINEMEASURE_COMPENSATION_AD
#define N_SAMPLE_V_LINE 					CONFIG_VLINEMEASURE_NUM_OF_SAMPLES

/*---------------- Analog Feedback ---------------------*/
/* 
Required by Analog Feedback. ghost 
*/
#if defined(CONFIG_MANAGE_AD_CHANNEL_READ_SUPPORT_ENABLE)
#define MANAGE_AD_CHANNEL_READ  			TRUE
#else
#define MANAGE_AD_CHANNEL_READ          	FALSE
#endif
#if defined(CONFIG_PM_ANALOG_FEEDBACKS_NUM)
#define N_ANALOG_FEEDBACK               	CONFIG_PM_ANALOG_FEEDBACKS_NUM  /* Numbers of analog feedbacks */
#endif
/*----------------------- Don't touch below ----------------*/
#if (ADC_USE_HW_DMA==1)
