...
#define FAULTSRC_DRAINPUMP_TRIAC_DM_TRN		2
#define FAULTSRC_DRAINPUMP_TRIAC_DM_ON		3
#define FAULTSRC_DRAINPUMP_TRIAC_DM_OFF		4
#define FAULTSRC_DRAINPUMP_FB_KO_ON			5
#define FAULTSRC_DRAINPUMP_FB_KO_OFF		6
#define FAULTSRC_DRAINPUMP_FB_KO_TRN		7
#define FAULTSRC_DRAINPUMP_BLOCKED			8
#define FAULTSRC_DRAINPUMP_TRIAC_OC			9
#define FAULTSRC_DRAINPUMP_BAD_SETTING		10
...
#define DRAIN_CS_TRANS_OK			(PM_CS_STATUS_TRANS | PM_CS_VALUE_OK)
#define DRAIN_CS_TRANS_ERR_GENERIC	(PM_CS_STATUS_TRANS | PM_CS_VALUE_ERR_GENERIC)
#define DRAIN_CS_TRANS_ERR_SC 		(PM_CS_STATUS_TRANS | PM_CS_VALUE_ERR_SC)
#define DRAIN_CS_TRANS_ERR_OC		(PM_CS_STATUS_TRANS | PM_CS_VALUE_ERR_OC)
#define DRAIN_CS_TRANS_ERR_DM		(PM_CS_STATUS_TRANS | PM_CS_VALUE_ERR_DM)
