...
#define DR_CS_TRN_OK					(PM_CS_STATUS_TRANS	| PM_CS_VALUE_OK)
...
#define DR_CS_TRN_GEN_ERR				(PM_CS_STATUS_TRANS	| PM_CS_VALUE_ERR_GENERIC)
#define DR_CS_OFF_RELE_TRIAC_SC			(PM_CS_STATUS_OFF	| PM_CS_VALUE_ERR_SC)
#define DR_CS_TRN_RELE_TRIAC_SC			(PM_CS_STATUS_TRANS	| PM_CS_VALUE_ERR_SC)
