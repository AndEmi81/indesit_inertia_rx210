...
typedef struct
{
  ...
  __IO uint32_t SYSRESSTAT;             /*!< Offset: 0x030 System reset status Register (R/ ) 
                                        __I  uint32_t SYSRESSTAT; is the orginal definition with __I attribute = (R/ )

                                        But manual states that 
                                        4.9 System reset status register
                                        The SYSRSTSTAT register shows the source of the latest reset event. The bits are
                                        cleared by writing a one to any of the bits.
...
{    
  ...
  __I  uint32_t RIS;					/*!< Offset: 0x014 (R/ )  Raw interrupt status Register */
...
typedef struct
{
  ...
  __IO uint32_t SYSCFG;                 /*!< Offset: 0x014 System configuration registe (R/W) */
} LPC_PMU_TypeDef;
...
extern volatile __i2conset_bits  _I2C0CONSET;      
extern volatile __i2stat_bits    _I2C0STAT;
extern volatile __i2dat_bits     _I2C0DAT;
extern volatile __i2adr_bits     _I2C0ADR;
extern volatile __i2sch_bits     _I2C0SCLH;
extern volatile __i2scl_bits     _I2C0SCLL;
extern volatile __i2conclr_bits  _I2C0CONCLR;
extern volatile __i2cmmctrl_bits _I2C0MMCTRL;
extern volatile __i2adr_bits     _I2C0ADR1;
extern volatile __i2adr_bits     _I2C0ADR2;
extern volatile __i2adr_bits     _I2C0ADR3;
//extern volatile __i2dat_bits     _I2C0DATABUFFER;
extern  uint8_t                  _I2C0DATABUFFER;
extern volatile __i2cmask_bits   _I2C0MASK0;
extern volatile __i2cmask_bits   _I2C0MASK1;
extern volatile __i2cmask_bits   _I2C0MASK2;
extern volatile __i2cmask_bits   _I2C0MASK3;


#define _RST_COPY_VALUE         (*((unsigned int    *) 0x10001FDC))
#define _BOOT_KEY               (*((unsigned int    *) 0x10001FD8))
