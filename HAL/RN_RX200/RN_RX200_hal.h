/**
 \par Description
 \n Microcontroller Renesas RX200 Family HAL parameters
...
#ifndef __HAL_RN_R5F2108_HAL_H
#define __HAL_RN_R5F2108_HAL_H
...
#define _HAL_RX210_MODULE_STOP_CONTROL_1_REGISTER_B		SYSTEM.MSTPCRB.LONG /* Module Stop Contro l Register B*/
...
#define _HAL_RX210_ICU_IPR(vector)							ICU.IPR[vector].BYTE
/* Interrupt Request Enable Register */
#define _HAL_RX210_INTERRUPT_REQUEST_ENABLE_REGISTER(ier)	ICU.IER[ier].BYTE
/* Interrupt Request Register */
#define _HAL_RX210_INTERRUPT_REQUEST_REGISTER(vector)		ICU.IR[vector].BYTE
...
#define _HAL_RX210_VOLTAGE_MONITOR_CONTROL_REGISTER		SYSTEM.LVCMPCR.BYTE
...
#define _HAL_RX210_VOLTAGE_DETECTION_LEVEL_SELECT_REGISTER		SYSTEM.LVDLVLR.BYTE
...
#define _HAL_RX210_VOLTAGE_MONITORING_1_CIRCUIT_COMPARATOR_REGISTER_0		SYSTEM.LVD1CR0.BYTE
...
#define _HAL_RX210_VOLTAGE_MONITORING_2_CIRCUIT_COMPARATOR_REGISTER_0		SYSTEM.LVD2CR0.BYTE
...
#define _HAL_RX210_VOLTAGE_MONITORING_1_CIRCUIT_COMPARATOR_REGISTER_1		SYSTEM.LVD1CR1.BYTE
/* Voltage Monitoring 1 Circuit/Comparator A1 Status Register */
#define _HAL_RX210_VOLTAGE_MONITORING_1_STATUS_REGISTER		SYSTEM.LVD1SR.BYTE
#define LVD1SR_LVD1DET_MASK		(1<<0)
/*Voltage Monitoring 2 Circuit/Comparator A2 Control Register 1*/
#define _HAL_RX210_VOLTAGE_MONITORING_2_CIRCUIT_COMPARATOR_REGISTER_1		SYSTEM.LVD2CR1.BYTE
/*Voltage Monitoring 2 Circuit/Comparator A2 Status register*/
#define _HAL_RX210_VOLTAGE_MONITORING_2_STATUS_REGISTER		SYSTEM.LVD2SR.BYTE
...
#define LVDR_Disable(){\
		DISABLE_REGISTER_WRITE_PROTECTION;\
		_HAL_RX210_VOLTAGE_MONITOR_CONTROL_REGISTER = 0x00;\
		_HAL_RX210_VOLTAGE_MONITORING_1_CIRCUIT_COMPARATOR_REGISTER_0 = 0x82;\
		ENABLE_REGISTER_WRITE_PROTECTION;\
}
#define LVDWarningIntOn(){\
		_HAL_RX210_ICU_IPR(LVD_INTERRUPT_VECTOR) = LVD_INTERRUPT_PRIORITY ;\
		_HAL_RX210_INTERRUPT_REQUEST_REGISTER(LVD_INTERRUPT_VECTOR) = 0x00;\
		_HAL_RX210_INTERRUPT_REQUEST_ENABLE_REGISTER(LVD_INTERRUPT_IER_REGISTER) |= LVD2_IER_ENABLE_MASK;\
}
#define LVDWarningIntOff(){\
		_HAL_RX210_INTERRUPT_REQUEST_REGISTER(LVD_INTERRUPT_VECTOR) = 0x00;\
		_HAL_RX210_VOLTAGE_MONITORING_2_CIRCUIT_COMPARATOR_REGISTER_0 &= ~LVD2CR0_LVD2RIE_MASK;\
		_HAL_RX210_ICU_IPR(LVD_INTERRUPT_VECTOR) = 0x00;\
}
#define LVDGetWarningFlag()	(_HAL_RX210_VOLTAGE_MONITOR_CONTROL_REGISTER & 0x40)
#define LVDWarningAcknoledge()	_HAL_RX210_INTERRUPT_REQUEST_REGISTER(LVD_INTERRUPT_VECTOR) = 0x00	/*It is automatically cancelled*/
#define LVDSetStopOn()
...
#define _RX210_RESET_STATUS_REGISTER_0					SYSTEM.RSTSR0.BYTE
#define _RX210_POWER_ON_RESET_FLAG_MASK					0x01
#define _RX210_VOLTAGE_MONITOR_0_RESET_FLAG_MASK		0x02
#define _RX210_VOLTAGE_MONITOR_1_RESET_FLAG_MASK		0x04
#define _RX210_VOLTAGE_MONITOR_2_RESET_FLAG_MASK		0x08
#define _RX210_DEEP_SOFTWARE_STANDBY_RESET_FLAG_MASK	0x80
/* Reset Status Register 1 */
#define _RX210_RESET_STATUS_REGISTER_1					SYSTEM.RSTSR1.BYTE
#define _RX210_COLD_WARM_START_FLAG_MASK				0x01
/* Reset Status Register 2 */
#define _RX210_RESET_STATUS_REGISTER_2					SYSTEM.RSTSR2.BYTE
#define _RX210_IWDT_RESET_FLAG_MASK						0x01
#define _RX210_WDT_TIMER_RESET_FLAG_MASK				0x02
#define _RX210_SOFTWARE_RESET_FLAG_MASK					0x04
/* Software Reset Status Register */
#define _RX210_SOFTWARE_RESET_STATUS_REGISTER			SYSTEM.SWRR		/* Writing A501h re sets the LSI. These bits are read as 0000h.*/
/**/
...
#define UserReset()		{DISABLE_REGISTER_WRITE_PROTECTION;_RX210_SOFTWARE_RESET_STATUS_REGISTER = 0xA501;}
...
/************/
#define CLK_MAX_DEVICE_FREQ         50000000			/* RX210 Max System Frequency*/

/************/
/* INT CLK */
/************/
#define CLK_INT_CLOCK_FREQ   		20000000			/* CLK value in MHz*/
/************/
/* EXT CLK */
/************/
...
#define CLK_MIN_REF_RANGE           					/* AE to check*/
#define CLK_MAX_REF_RANGE           					/* AE to check*/
/* PLL Reference value */
#define PLL_MIN_INPUT_FREQ    			4000000			/* PLL Min Input Frequency*/
#define PLL_MAX_INPUT_FREQ    			12000000		/* PLL Max Input Frequency*/
#define PLL_MIN_OUPUT_FREQ				50000000		/* PLL Min Output Frequency*/
#define PLL_MAX_OUPUT_FREQ				100000000		/* PLL Max Output Frequency*/
/* Clock Max Value*/
#define MAX_ICLK_FREQUENCY				50000000		/* Max ICLK (system clock frquency)*/
#define MAX_PCLKB_FREQUENCY				32000000		/* Max PCLKB Frequency*/
#define MAX_PCLKD_FREQUENCY				50000000		/* Max PCLKD Frequency*/
#define MAX_FCLK_FREQUENCY				32000000		/* Max FCLK Frequency*/
#define MAX_BCLK_FREQUENCY				25000000		/* Max BCLK Frequency*/
...
/************/
#define _HAL_RX210_CLK_SCKCR_REG	SYSTEM.SCKCR.LONG	/* System Clock Control Register, Select the divider*/
#define _HAL_RX210_CLK_SCKCR_FCK	SYSTEM.SCKCR.BIT.FCK	/* SCKCR FLASK IK Clock nibble*/
#define _HAL_RX210_CLK_SCKCR_ICK	SYSTEM.SCKCR.BIT.ICK	/* SCKCR ICK System Clock nibble*/
#define _HAL_RX210_CLK_SCKCR_PSTOP1	SYSTEM.SCKCR.BIT.PSTOP1	/* SCKCR PSTOP1 bit*/
#define _HAL_RX210_CLK_SCKCR_BCK	SYSTEM.SCKCR.BIT.BCK	/* SCKCR BCK External bus clock nibble*/
#define _HAL_RX210_CLK_SCKCR_PCKB	SYSTEM.SCKCR.BIT.PCKB	/* SCKCR PCKB Peripheral module clock nibble*/
#define _HAL_RX210_CLK_SCKCR_PCKD	SYSTEM.SCKCR.BIT.PCKD	/* SCKCR BCK Peripheral module clock D nibble*/
#define _HAL_RX210_CLK_SCKCR3_REG	SYSTEM.SCKCR3.WORD	/* System Clock Control Register 3*/
#define _HAL_RX210_CLK_PLLCR_REG	SYSTEM.PLLCR.WORD	/* PLL Control Register*/
#define _HAL_RX210_CLK_PLLCR2_REG	SYSTEM.PLLCR2.BYTE	/* PLL Control Register 2*/
#define _HAL_RX210_CLK_BCKCR_REG	SYSTEM.BCKCR.BYTE	/* External Bus clock control register*/
#define _HAL_RX210_CLK_MOSCCR_REG	SYSTEM.MOSCCR.BYTE	/* Main Clock oscillator control register*/
#define _HAL_RX210_CLK_SOSCCR_REG	SYSTEM.SOSCCR.BYTE	/* Sub-clock oscillator control register*/
#define _HAL_RX210_CLK_LOCOCR_REG	SYSTEM.LOCOCR.BYTE	/* Low-speed clock oscillator control register*/
#define _HAL_RX210_CLK_ILOCOCR_REG	SYSTEM.ILOCOCR.BYTE	/* IWDT-dedicated low-speed clock oscillator control register*/
#define _HAL_RX210_CLK_HOCOCR_REG	SYSTEM.HOCOCR.BYTE	/* High-speed clock oscillator control register*/
#define _HAL_RX210_CLK_HOCOCR2_REG	SYSTEM.HOCOCR2.BYTE	/* High-speed clock oscillator control register 2*/
#define _HAL_RX210_CLK_OSTDCR_REG	SYSTEM.OSTDCR.BYTE	/* Oscillation stop detection control register*/
#define _HAL_RX210_CLK_OSTDSR_REG	SYSTEM.OSTDSR.BYTE	/* Oscillation stop detection status register*/
#define _HAL_RX210_CLK_MOFCR_REG	SYSTEM.MOFCR.BYTE	/* Main Clock oscillator forced oscillation control register*/
#define _HAL_RX210_CLK_HOCOPCR_REG	SYSTEM.HOCOPCR.BYTE	/* High-speed on-chip oscillator power supply control register*/
#define _HAL_RX210_CLK_MOSCWTCR_REG	SYSTEM.MOSCWTCR.BYTE/* Main Clock oscillator Wait Control Register*/
/*** Set Clock Source ***/
#define INTERNAL_CLK_LOW_SPEED	0x0000				/* INT Clock LOCO 		(Low Speed Mode)*/
#define INTERNAL_CLK_SOURCE     0x0100				/* INT Clock Select HOCO	(High Speed Mode)*/
#define SYSTEM_CLK_SOURCE       0x0200				/* EXT CLK without PLL*/
#define PLL_OUT_CLK_SOURCE	    0x0400				/* EXT CLK with PLL*/
#define CLK_SetPLLOutClockSource()		{_HAL_RX210_CLK_SCKCR3_REG = PLL_OUT__CLK_SOURCE;}	/* PLL Work with EXT CLK*/
#define CLK_SetInternalClockSource()	{_HAL_RX210_CLK_SCKCR3_REG = INTERNAL_CLK_SOURCE;} 	/* HOCO mode*/
#define CLK_SetExternalClockSource()	{_HAL_RX210_CLK_SCKCR3_REG = SYSTEM_CLK_SOURCE;}	/* EXT CLK without PLL*/
...
#define CLK_SetInternalPLLRefClock()                {}	/* Do not applicable in RX210*/
#define CLK_SetExternalPLLRefClock()                {_HAL_RX210_CLK_SCKCR3_REG = SYSTEM_CLK_SOURCE;}

#define CLK_TurnsPLLOff()                           {_HAL_RX210_CLK_PLLCR2_REG |= 0x01;}
#define CLK_TurnsPLLOn()                            {_HAL_RX210_CLK_PLLCR2_REG &= 0x00;}
...
#define CLK_SetBusFreqDiv(divider)                  {_HAL_RX210_CLK_SCKCR_REG = (uint8_t)divider;}
...
#define DIO_Init()     /*! TODO. Ask the desidered behaviour*/
...
/* DIO_SetLow - Set output port low (ok test) */
...
/*!< DIO_IsPullUpEnabled ( ok tested) */
#define DIO_PullUpEnable(ptr)\
		*(&(( (portreg_struct_t *)ptr->PortAddress.basic)->direction)+REG_PCR_MASK) |= ptr->PinMask;
/*!< PULL UP Disable ( ok tested) */
#define DIO_PullUpDisable(ptr)\
		*(&(( (portreg_struct_t *)ptr->PortAddress.basic)->direction)+REG_PCR_MASK) &= ~(ptr->PinMask);
/* PULL UP Checj (ok tested)*/
#define DIO_IsPullUpEnabled(ptr)\
		((*(&(( (portreg_struct_t *)ptr->PortAddress.basic)->direction)+REG_PCR_MASK) & ptr->PinMask) != 0)
...
#define DIGITAL_FILTER_CLOCK_IRQ	2500
...
typedef struct IO_DIGITAL_NOISE_tag
{
    ...
    uint8_t MPCFuncVal; /**< Port pin mask  */
    uint8_t channel;
    uint8_t digital_filter_peripheral;
} IO_DIGITAL_NOISE_MapType;

#define IO_DIGITAL_FILTER_PIN(x,y,t,z,h) {\
(DIO_PortAddressBasicType)&PORT##x##_PDR,\
(uint8_t *)&MPC.P##x##y##PFS.BYTE,\
(DIO_ModuleMapMaskType)PORTX_BIT##y##_MASK,\
t,\
z,\
h\
...
#define _HAL_RX210_I2C_ICCR1_REG	RIIC0.ICCR1.BYTE					/* I2C Bus Control register 1*/
#define _HAL_RX210_I2C_ICCR2_REG	RIIC0.ICCR2.BYTE					/* I2C Bus Control register 2*/
#define _HAL_RX210_I2C_ICMR1_REG	RIIC0.ICMR1.BYTE					/* I2C Bus mode register 1*/
#define _HAL_RX210_I2C_ICMR2_REG	RIIC0.ICMR2.BYTE					/* I2C Bus mode register 2*/
#define _HAL_RX210_I2C_ICMR3_REG	RIIC0.ICMR3.BYTE					/* I2C Bus mode register 3*/
#define _HAL_RX210_I2C_ICFER_REG	RIIC0.ICFER.BYTE					/* I2C bus function enable register*/
#define _HAL_RX210_I2C_ICSER_REG	RIIC0.ICSER.BYTE					/* I2C Bus status Enable register*/
#define _HAL_RX210_I2C_ICIER_REG	RIIC0.ICIER.BYTE					/* I2C Bus Interrupt Control register*/
#define _HAL_RX210_I2C_ICSR1_REG	RIIC0.ICSR1.BYTE					/* I2C Bus status register 1*/
#define _HAL_RX210_I2C_ICSR2_REG	RIIC0.ICSR2.BYTE					/* I2C Bus status register 2*/
#define _HAL_RX210_I2C_SARL0_REG	RIIC0.SARL0.BYTE					/* I2C Slave address Register L0*/
#define _HAL_RX210_I2C_SARL1_REG	RIIC0.SARL1.BYTE					/* I2C Slave address Register L1*/
#define _HAL_RX210_I2C_SARL2_REG	RIIC0.SARL2.BYTE					/* I2C Slave address Register L2*/
#define _HAL_RX210_I2C_SARU0_REG	RIIC0.SARU0.BYTE					/* I2C Slave address Register U0*/
#define _HAL_RX210_I2C_SARU1_REG	RIIC0.SARU1.BYTE					/* I2C Slave address Register U1*/
#define _HAL_RX210_I2C_SARU2_REG	RIIC0.SARU2.BYTE					/* I2C Slave address Register U2*/
#define _HAL_RX210_I2C_ICBRL_REG	RIIC0.ICBRL.BYTE					/* I2C Bus Bit  rate Low-level register*/
#define _HAL_RX210_I2C_ICBRH_REG	RIIC0.ICBRH.BYTE					/* I2C Bus Bit rate High-level register*/
#define _HAL_RX210_I2C_ICDRT_REG	RIIC0.ICDRT							/* I2C Bust Trasmit Data Register*/
#define _HAL_RX210_I2C_ICDRR_REG	RIIC0.ICDRR							/* I2C Bus Receiver Data register*/
#define _HAL_RX210_I2C_ICDRS_REG	RIIC0.ICDRS.BYTE					/* I2C Bus shift register*/
/* Masks */
#define _HAL_RX210_I2C_ICCR2_ST_MASK					0x02
#define _HAL_RX210_I2C_ICCR2_RS_MASK					0x04
#define _HAL_RX210_I2C_ICCR2_SP_MASK					0x08
#define _HAL_RX210_I2C_ICCR2_RSPA_MASK					0x10
#define _HAL_RX210_I2C_ICCR2_TRS_MASK					0x20
#define _HAL_RX210_I2C_ICCR2_MST_MASK					0x40
#define _HAL_RX210_I2C_ICCR2_BBSY_MASK					0x80

#define _HAL_RX210_I2C_ICSR1_AAS0_MASK					0x01
#define _HAL_RX210_I2C_ICSR1_AAS1_MASK					0x02
#define _HAL_RX210_I2C_ICSR1_AAS2_MASK					0x04
#define _HAL_RX210_I2C_ICSR1_GCA_MASK					0x08
#define _HAL_RX210_I2C_ICSR1_DID_MASK					0x20
#define _HAL_RX210_I2C_ICSR1_HOA_MASK					0x80

#define _HAL_RX210_I2C_ICSR2_TMOF_MASK					0x01
#define _HAL_RX210_I2C_ICSR2_AL_MASK					0x02
#define _HAL_RX210_I2C_ICSR2_START_MASK					0x04
#define _HAL_RX210_I2C_ICSR2_STOP_MASK					0x08
#define _HAL_RX210_I2C_ICSR2_NACKF_MASK					0x10
#define _HAL_RX210_I2C_ICSR2_RDRF_MASK					0x20
#define _HAL_RX210_I2C_ICSR2_TEND_MASK					0x40
#define _HAL_RX210_I2C_ICSR2_TDRE_MASK					0x80

#define _HAL_RX210_I2C_ICMR3_ACKBR_MASK					0x04
#define _HAL_RX210_I2C_ICMR3_ACKBT_MASK					0x08
#define _HAL_RX210_I2C_ICMR3_ACKWP_MASK					0x10
#define _HAL_RX210_I2C_ICMR3_RDRFS_MASK					0x20
#define _HAL_RX210_I2C_ICMR3_WAIT_MASK					0x40
#define _HAL_RX210_I2C_ICMR3_SMBS_MASK					0x80

#define _HAL_RX210_I2C_ICIER_TMOIE_MASK					0x01
#define _HAL_RX210_I2C_ICIER_ALIE_MASK					0x02
#define _HAL_RX210_I2C_ICIER_STIE_MASK					0x04
#define _HAL_RX210_I2C_ICIER_SPIE_MASK					0x08
#define _HAL_RX210_I2C_ICIER_NACKIE_MASK				0x10
#define _HAL_RX210_I2C_ICIER_RIE_MASK					0x20
#define _HAL_RX210_I2C_ICIER_TEIE_MASK					0x40
#define _HAL_RX210_I2C_ICIER_TIE_MASK					0x80

/** Interrupt Definitions **/
/* I2C EEI INTERRUPT DEFINE*/

#define	I2C_EEI_INTERRUPT_ENABLE	_HAL_RX210_I2C_ICIER_REG |= _HAL_RX210_I2C_ICIER_NACKIE_MASK
#define I2C_EEI_INTERRUPT_DISABLE	_HAL_RX210_I2C_ICIER_REG &= ~_HAL_RX210_I2C_ICIER_NACKIE_MASK
...
#define	I2C_RX_INTERRUPT_ENABLE		_HAL_RX210_I2C_ICIER_REG |= _HAL_RX210_I2C_ICIER_RIE_MASK
#define I2C_RX_INTERRUPT_DISABLE	_HAL_RX210_I2C_ICIER_REG &= ~_HAL_RX210_I2C_ICIER_RIE_MASK
...
#define	I2C_TX_INTERRUPT_ENABLE		_HAL_RX210_I2C_ICIER_REG |= _HAL_RX210_I2C_ICIER_TIE_MASK
#define I2C_TX_INTERRUPT_DISABLE	_HAL_RX210_I2C_ICIER_REG &= ~_HAL_RX210_I2C_ICIER_TIE_MASK
...
#define	I2C_TX_END_INTERRUPT_ENABLE		_HAL_RX210_I2C_ICIER_REG |= _HAL_RX210_I2C_ICIER_TEIE_MASK
#define I2C_TX_END_INTERRUPT_DISABLE	_HAL_RX210_I2C_ICIER_REG &= ~_HAL_RX210_I2C_ICIER_TEIE_MASK
...
#define _HAL_I2C_START_CONDITION 	_HAL_RX210_I2C_ICCR2_REG = 0x02
#define _HAL_I2C_RESTART_CONDITION 	_HAL_RX210_I2C_ICCR2_REG = 0x04
#define _HAL_I2C_STOP_CONDITION 	_HAL_RX210_I2C_ICCR2_REG = 0x08
...
/* Address Type Macro */
#define _HAL_RX_I2C_ADDR0_7BITS		_HAL_RX210_I2C_SARU0_REG =  0x00		/* The 7-bit address format is selected*/
#define _HAL_RX_I2C_ADDR0_10BITS	_HAL_RX210_I2C_SARU0_REG |= 0x01		/* The 10-bit address format is selected*/
#define _HAL_RX_I2C_ADDR1_7BITS		_HAL_RX210_I2C_SARU1_REG =  0x00		/* The 7-bit address format is selected*/
#define _HAL_RX_I2C_ADDR1_10BITS	_HAL_RX210_I2C_SARU1_REG |= 0x01		/* The 10-bit address format is selected*/
#define _HAL_RX_I2C_ADDR2_7BITS		_HAL_RX210_I2C_SARU2_REG =  0x00		/* The 7-bit address format is selected*/
#define _HAL_RX_I2C_ADDR2_10BITS	_HAL_RX210_I2C_SARU2_REG |= 0x01		/* The 10-bit address format is selected*/
/* Control Registers Set and Reset*/
#define _HAL_RX210_I2C_ENABLE_REG	_HAL_RX210_I2C_ICCR1_REG = 0x90

/* Flow Control Registers */
#define _HAL_RX210_I2C_DISABLE_REG	_HAL_RX210_I2C_ICCR1_REG = 0x10

/* Status Registers*/
#define _HAL_RX210_I2C_STATUS_REG	_HAL_RX210_I2C_ICSR1_REG		/* RIIC status register*/
#define _HAL_RX210_I2C_BUSBUSY_REG	(_HAL_RX210_I2C_ICCR2_REG & 0x80)
 ...
 * Status: Verified
 */
#define I2C_CtrlReset()	{ _HAL_RX210_I2C_ICCR1_REG = 0x10; _HAL_RX210_I2C_ICCR1_REG = 0x50; }
 ...
 * Status: Verified
 */
#define I2C_Reset()       { _HAL_RX210_I2C_ICCR1_REG = 0xD0; _HAL_RX210_I2C_ICCR1_REG = 0x90; }
 ...
 * Status: Verified
 */
#define I2C_ReadData()    _HAL_RX210_I2C_ICDRR_REG
...
#define I2C_WriteData(b)  { _HAL_RX210_I2C_ICDRT_REG = ((I2C_DataRegType)(b)); }
...
#define I2C_SendAddr(b)  { \
		_HAL_RX210_I2C_ICDRT_REG = ((I2C_DataRegType)(b)); \
		if ((b) & 0x01) \
		{ \
			int addrDelay = 0;\
			while ( ((_HAL_RX210_I2C_ICSR2_REG & _HAL_RX210_I2C_ICSR2_RDRF_MASK) == 0) && (addrDelay<500)) \
			{ \
				addrDelay++; \
				if (!(addrDelay % 200)) \
				{ \
 ...
 */
#define I2C_pReceiveDataRegister() ((uint8_t *)& _HAL_RX210_I2C_ICDRR_REG)
 ...
 * Status: Check meaning
 */
#define I2C_pTransmitDataRegister() ((uint8_t *)& _HAL_RX210_I2C_ICDRT_REG)
...
#define I2C_SetClockRate(b)\
		{\
			RIIC0.ICMR1.BYTE = ((HAL_RX210_I2C_CKS_SETTING << 4) | 0x08);\
			RIIC0.ICBRH.BYTE = 0xE0 | HAL_RX210_I2C_ICBRH_SETTING;\
			RIIC0.ICBRL.BYTE = 0xE0 | HAL_RX210_I2C_ICBRL_SETTING;\
			RIIC0.ICMR2.BIT.SDDL = HAL_RX210_I2C_SDDL_SETTING;\
			RIIC0.ICMR2.BIT.DLCS = HAL_RX210_I2C_DLCS_SETTING;\
...
#define I2C_SetSlaveAddress(b)\
		{\
			_HAL_RX210_I2C_SARL0_REG = (I2C_SlaveAddressType)(b);\
 ...
 * Status: Verified
 */
#define     I2C_IsTxMode()	((_HAL_RX210_I2C_ICCR2_REG & _HAL_RX210_I2C_ICCR2_TRS_MASK) != 0x00)
...
#define     I2C_IssueStartCondition()	{ \
		...
		while (((_HAL_RX210_I2C_ICSR2_REG & _HAL_RX210_I2C_ICSR2_TDRE_MASK) == 0) && (stDelay < 100)) {stDelay++;} \
	}
...
#define     I2C_IssueReStartCondition() { \
		...
		while (((_HAL_RX210_I2C_ICSR2_REG & _HAL_RX210_I2C_ICSR2_TDRE_MASK) == 0) && (rstDelay < 100)) {rstDelay++;} \
	}
...
#define     I2C_IssueStopCondition()  { \
		int spDelay = 0;\
		_HAL_RX210_I2C_ICSR2_REG &= ~_HAL_RX210_I2C_ICSR2_STOP_MASK; \
		_HAL_I2C_STOP_CONDITION; \
		I2C_DummyRead(); \
		while (((_HAL_RX210_I2C_ICSR2_REG & _HAL_RX210_I2C_ICSR2_STOP_MASK) == 0) && (spDelay < 100))  {spDelay++;} \
		I2C_ResetStatus(); \
	}
...
#define     I2C_IsBusBusy()  ((_HAL_RX210_I2C_ICCR2_REG & _HAL_RX210_I2C_ICCR2_BBSY_MASK) != 0)
/*
 ...
 * Status:
 */
#define     I2C_IsSdaIoHigh() ((_HAL_RX210_I2C_ICCR1_REG & 0x01) != 0)
 ...
 * Status:
 */
#define     I2C_IsSclIoHigh() ((_HAL_RX210_I2C_ICCR1_REG & 0x02) != 0)
 ...
 * Status:
 */
#define     I2C_GetStatus() (_HAL_RX210_I2C_STATUS_REG)
 ...
 * Status:
 */
#define     I2C_ResetStatus() 	{	(void) _HAL_RX210_I2C_ICSR1_REG; \
									_HAL_RX210_I2C_ICSR1_REG = 0; \
									(void) _HAL_RX210_I2C_ICSR2_REG; \
									_HAL_RX210_I2C_ICSR2_REG = 0; }
 ...
 * Status: Test me!
 */
#define	I2C_IsArbitrationLost()  ((_HAL_RX210_I2C_ICSR2_REG & _HAL_RX210_I2C_ICSR2_AL_MASK) == _HAL_RX210_I2C_ICSR2_AL_MASK)
 ...
 * Status Test for S0!
 */
#define     I2C_IsSlaveAddressed()  (( (_HAL_RX210_I2C_ICSR1_REG & _HAL_RX210_I2C_ICSR1_AAS0_MASK) == _HAL_RX210_I2C_ICSR1_AAS0_MASK) ||\
										((_HAL_RX210_I2C_ICSR1_REG & _HAL_RX210_I2C_ICSR1_AAS1_MASK) == _HAL_RX210_I2C_ICSR1_AAS1_MASK) ||\
										((_HAL_RX210_I2C_ICSR1_REG & _HAL_RX210_I2C_ICSR1_AAS2_MASK) == _HAL_RX210_I2C_ICSR1_AAS2_MASK))
 ...
 * Status:
 */
#define     I2C_IsGeneralCallAddress() ((_HAL_RX210_I2C_ICSR1_REG & _HAL_RX210_I2C_ICSR1_GCA_MASK) == _HAL_RX210_I2C_ICSR1_GCA_MASK)	/* ICSR1 General Call Address*/
/*
...
#define     I2C_ResetSlaveAddressedSig() {\
				if((_HAL_RX210_I2C_ICSR1_REG & _HAL_RX210_I2C_ICSR1_AAS0_MASK) == _HAL_RX210_I2C_ICSR1_AAS0_MASK)\
					_HAL_RX210_I2C_ICSR1_REG &= ~_HAL_RX210_I2C_ICSR1_AAS0_MASK;\
				if((_HAL_RX210_I2C_ICSR1_REG & _HAL_RX210_I2C_ICSR1_AAS1_MASK) == _HAL_RX210_I2C_ICSR1_AAS1_MASK)\
					_HAL_RX210_I2C_ICSR1_REG &= ~_HAL_RX210_I2C_ICSR1_AAS1_MASK;\
				if((_HAL_RX210_I2C_ICSR1_REG & _HAL_RX210_I2C_ICSR1_AAS2_MASK) == _HAL_RX210_I2C_ICSR1_AAS2_MASK)\
					_HAL_RX210_I2C_ICSR1_REG &= ~_HAL_RX210_I2C_ICSR1_AAS2_MASK;\
 ...
 * Status:
 */
#define     I2C_ResetGeneralCallAddressSig() {_HAL_RX210_I2C_ICSR1_REG &= ~_HAL_RX210_I2C_ICSR1_GCA_MASK;}
 ...
 * Status:
 */
#define     I2C_ResetArbitrationLost() {_HAL_RX210_I2C_ICSR2_REG &= ~_HAL_RX210_I2C_ICSR2_AL_MASK;}
 ...
 * Status: Test me!
 */
#define     I2C_IsSlaveTrasmitRequest()  ((_HAL_RX210_I2C_ICCR2_REG & (_HAL_RX210_I2C_ICCR2_MST_MASK | _HAL_RX210_I2C_ICCR2_TRS_MASK)) == _HAL_RX210_I2C_ICCR2_TRS_MASK)
 ...
 * Status:
 */
#define     I2C_IsAcknowledgeEnabled() ((_HAL_RX210_I2C_ICMR3_REG & _HAL_RX210_I2C_ICMR3_ACKBT_MASK) == 0)
 ...
 * Status: Verified
 */
#define     I2C_IsMaster() ((_HAL_RX210_I2C_ICCR2_REG & _HAL_RX210_I2C_ICCR2_MST_MASK) == _HAL_RX210_I2C_ICCR2_MST_MASK)
 ...
 * Status:
 */
#define     I2C_ResetTxSig() {_HAL_RX210_I2C_ICSR2_REG &= ~_HAL_RX210_I2C_ICSR2_TEND_MASK; }
/*
 ...
 * Status: Verified
 */
#define     I2C_ReceivedAcknowledgeVal() ((_HAL_RX210_I2C_ICMR3_REG & _HAL_RX210_I2C_ICMR3_ACKBR_MASK) != 0)
 ...
 * Status: Verified
 */
#define     I2C_EnableAcknowledge()    {	_HAL_RX210_I2C_ICMR3_REG |= _HAL_RX210_I2C_ICMR3_ACKWP_MASK; \
											_HAL_RX210_I2C_ICMR3_REG &= ~_HAL_RX210_I2C_ICMR3_ACKBT_MASK; \
											_HAL_RX210_I2C_ICMR3_REG &= ~_HAL_RX210_I2C_ICMR3_ACKWP_MASK; }
 ...
 * Status: Verified
 */
#define     I2C_DisableAcknowledge()	{	_HAL_RX210_I2C_ICMR3_REG |= _HAL_RX210_I2C_ICMR3_ACKWP_MASK; \
											_HAL_RX210_I2C_ICMR3_REG |= _HAL_RX210_I2C_ICMR3_ACKBT_MASK; \
											_HAL_RX210_I2C_ICMR3_REG &= ~_HAL_RX210_I2C_ICMR3_ACKWP_MASK; }
 ...
 * Status:
 */
#define I2C_Level3BlockMonitorSync()   ( (_HAL_RX210_I2C_ICCR2_REG & _HAL_RX210_I2C_ICCR2_TRS_MASK) & ((_HAL_RX210_I2C_ICMR3_REG & 0x08) == 0x80) )
 ...
 * Status:
 */
#define I2C_Level4BlockMonitorSync() ( (_HAL_RX210_I2C_ICCR2_REG & 0x60) & ((_HAL_RX210_I2C_ICMR3_REG & 0x08) == 0x80) )
 ...
 * Status:
 */
#define I2C_Level5BlockMonitorSync()	((_HAL_RX210_I2C_ICCR2_REG & 0x60) & (_HAL_RX210_I2C_ICMR3_REG & 0x08))
...
#define _HAL_RX200_UART_ERROR_MASK		    (_HAL_RX200_UART_SSR_PER_MASK | _HAL_RX200_UART_SSR_FER_MASK | _HAL_RX200_UART_SSR_ORER_MASK)
...
#define _HAL_RX200_UART_RDR_REG(channel) 			    (SCI##channel##_RDR)
#define _HAL_RX200_UART_TDR_REG(channel) 			    (SCI##channel##_TDR)
#define _HAL_RX200_UART_SMR_REG(channel) 			    (SCI##channel##_SMR)
#define _HAL_RX200_UART_SCR_REG(channel) 			    (SCI##channel##_SCR)
#define _HAL_RX200_UART_SSR_REG(channel) 			    (SCI##channel##_SSR)
#define _HAL_RX200_UART_BRR_REG(channel) 			    (SCI##channel##_BRR)
#define _HAL_RX200_UART_SCMR_REG(channel)               (SCI##channel##_SCMR)
...
#define _HAL_RX200_UART_SCR_CKE_MASK					0x03
#define _HAL_RX200_UART_SCR_TEIE_MASK					0x04
#define _HAL_RX200_UART_SCR_MPIE_MASK					0x08
#define _HAL_RX200_UART_SCR_RE_MASK						0x10
#define _HAL_RX200_UART_SCR_TE_MASK						0x20
#define _HAL_RX200_UART_SCR_RIE_MASK					0x40
#define _HAL_RX200_UART_SCR_TIE_MASK					0x80

/* SS - nuove */
#define _HAL_RX200_UART_SSR_TEND_MASK                   0x04
#define _HAL_RX200_UART_SSR_PER_MASK					0x08
#define _HAL_RX200_UART_SSR_FER_MASK					0x10
#define _HAL_RX200_UART_SSR_ORER_MASK					0x20
/*#define _HAL_RX200_UART_SSR_RDRF_MASK					0x40
#define _HAL_RX200_UART_SSR_TDRE_MASK					0x80*/
...
#define     UART_TxEnable(n){\
				_HAL_RX200_UART_SCR_REG(n) |= _HAL_RX200_UART_SCR_TE_MASK;\
}
 ...
 * Status: Verified on SCI0
 */
#define     UART_RxEnable(n)			_HAL_RX200_UART_SCR_REG(n) |= _HAL_RX200_UART_SCR_RE_MASK;
...
* Status: Verified on SCI0
*/
#define     UART_TxDisable(n)			_HAL_RX200_UART_SCR_REG(n) &= ~_HAL_RX200_UART_SCR_TE_MASK;
 ...
 * Status: Verified on SCI0
 */
#define     UART_RxDisable(n)			_HAL_RX200_UART_SCR_REG(n) &= ~_HAL_RX200_UART_SCR_RE_MASK;
 ...
 * Status: Verified on SCI0
 */
#define     UART_SetParityVal(n, val)		_HAL_RX200_UART_SMR_REG(n) |= (val<<5);
 ...
 * Status: Verified on SCI0
 */
#define     UART_SetParityMode(n, val)		_HAL_RX200_UART_SMR_REG(n) |= (val<<4);
 ...
 * Status: Verified on SCI0
 */
#define     UART_SetDataLen(n, val)			_HAL_RX200_UART_SMR_REG(n) |= (val<<6);
 ...
 * Status: Verified on SCI0
 */
#define     UART_SetClockDivisor(n, val)		_HAL_RX200_UART_SMR_REG(n) |= (val & 0x03);
 ...
 * Status: Verified on SCI0
 */
#define UART_ReadData(n)						_HAL_RX200_UART_RDR_REG(n);
 ...
 * Status: Verified on SCI0
 */
#define     UART_WriteData(n, b)				_HAL_RX200_UART_TDR_REG(n) = b;

#define     UART_pReceiveDataRegister(n) 		((UART_DataRegType*)&_HAL_RX200_UART_RDR_REG(n))

#define     UART_pTransmitDataRegister(n)   	((UART_DataRegType*)&_HAL_RX200_UART_TDR_REG(n))
 ...
 * Status: Verified on SCI0
 */
#define UART_SetBaudRate(n, b)				_HAL_RX200_UART_BRR_REG(n) = b;
...
#define     UART_TxIntEnable(n)\
			{\
				...
				_HAL_RX200_UART_SCR_REG(n) |= _HAL_RX200_UART_SCR_TEIE_MASK;\
...
#define     UART_RxIntEnable(n)\
			{\
				...
				_HAL_RX200_UART_SCR_REG(n) |= _HAL_RX200_UART_SCR_RIE_MASK;\
...
#define     UART_IsPeError(n)        	    (_HAL_RX200_UART_SSR_REG(n) & _HAL_RX200_UART_SSR_PER_MASK)
#define     UART_IsFerError(n)       	    (_HAL_RX200_UART_SSR_REG(n) & _HAL_RX200_UART_SSR_FER_MASK)
#define     UART_IsOerError(n)       	    (_HAL_RX200_UART_SSR_REG(n) & _HAL_RX200_UART_SSR_ORER_MASK)
#define     UART_IsError(n)				    (_HAL_RX200_UART_SSR_REG(n) & _HAL_RX200_UART_ERROR_MASK)
...
#define     UART_ClearError(n)       	    {\
												...
												_HAL_RX200_UART_SSR_REG(n) &= ~_HAL_RX200_UART_ERROR_MASK;\
												UART_ErrorProcessEnd(n)\
											}

#define 	UART_ResetPeError(n)		    {_HAL_RX200_UART_SSR_REG(n) &= ~_HAL_RX200_UART_SSR_PER_MASK;}
...
#define     UART_IsTxEndInt(n)			    ((_HAL_RX200_UART_SSR_REG(n) & _HAL_RX200_UART_SSR_TEND_MASK) != 0)
#define     UART_IsRxInt(n)           	    (1) /* it should test ( ICU.IR[SCIx_RX1_INT_VECTOR(n)].BYTE != 0x00) */

#define 	UART_IsTxDataRegFull(n)   	    ((_HAL_RX200_UART_SSR_REG(n) & (_HAL_RX200_UART_SSR_TEND_MASK)) == 0)
...
/* 8 is the maximum value for flash module clock divisor */
...
/* ADC RX210 PIN CONFIGURATION AS ANALOG */
/* Pin 40 as Analog Input AN000*/
#define ADC_CH0_PIN_AS_PERIPH	PORT4.PMR.BYTE	|= 0x01
#define ADC_CH0_PIN_AS_IO		{PORT4.PMR.BYTE	&= 0xFE;MPC.P40PFS.BYTE	&= 0x7F;}
#define ADC_CH0_PIN_AS_ANALOG	MPC.P40PFS.BYTE	|= 0x80
/* Pin 41 as Analog Input AN001*/
#define ADC_CH1_PIN_AS_PERIPH	PORT4.PMR.BYTE	|= 0x02
#define ADC_CH1_PIN_AS_IO		{PORT4.PMR.BYTE	&= 0xFD;MPC.P41PFS.BYTE	&= 0x7F;}
#define ADC_CH1_PIN_AS_ANALOG	MPC.P41PFS.BYTE	|= 0x80
/* Pin 42 as Analog Input AN002*/
#define ADC_CH2_PIN_AS_PERIPH	PORT4.PMR.BYTE	|= 0x04
#define ADC_CH2_PIN_AS_IO		{PORT4.PMR.BYTE	&= 0xBF;MPC.P42PFS.BYTE	&= 0x7F;}
#define ADC_CH2_PIN_AS_ANALOG	MPC.P42PFS.BYTE	|= 0x80
/* Pin 43 as Analog Input AN003*/
#define ADC_CH3_PIN_AS_PERIPH	PORT4.PMR.BYTE	|= 0x08
#define ADC_CH3_PIN_AS_IO		{PORT4.PMR.BYTE	&= 0xF7;MPC.P43PFS.BYTE	&= 0x7F;}
#define ADC_CH3_PIN_AS_ANALOG	MPC.P43PFS.BYTE	|= 0x80
/* Pin 44 as Analog Input AN004*/
#define ADC_CH4_PIN_AS_PERIPH	PORT4.PMR.BYTE	|= 0x10
#define ADC_CH4_PIN_AS_IO		{PORT4.PMR.BYTE	&= 0xEF;MPC.P44PFS.BYTE	&= 0x7F;}
#define ADC_CH4_PIN_AS_ANALOG	MPC.P44PFS.BYTE	|= 0x80
/* Pin 46 as Analog Input AN006*/
#define ADC_CH6_PIN_AS_PERIPH	PORT4.PMR.BYTE	|= 0x40
#define ADC_CH6_PIN_AS_IO		{PORT4.PMR.BYTE	&= 0xBF;MPC.P46PFS.BYTE	&= 0x7F;}
#define ADC_CH6_PIN_AS_ANALOG	MPC.P46PFS.BYTE	|= 0x80
/* Pin E7 as Analog Input AN008*/
#define ADC_CH8_PIN_AS_PERIPH	PORTE.PMR.BYTE	|= 0x01
#define ADC_CH8_PIN_AS_IO		{PORTE.PMR.BYTE	&= 0x7F;MPC.PE0PFS.BYTE	&= 0x7F;}
#define ADC_CH8_PIN_AS_ANALOG	MPC.PE0PFS.BYTE	|= 0x80
/* Pin E0 as Analog Input AN013*/
#define ADC_CH13_PIN_AS_PERIPH	PORTE.PMR.BYTE	|= 0x20
#define ADC_CH13_PIN_AS_IO		{PORTE.PMR.BYTE	&= 0xFE;MPC.PE5PFS.BYTE	&= 0x7F;}
#define ADC_CH13_PIN_AS_ANALOG	MPC.PE5PFS.BYTE	|= 0x80
...
/* RX210 Registers */
/* A/D Data Register*/
#define RX_210_ADC_ADDR0_REG	S12AD.ADDR0
#define RX_210_ADC_ADDR1_REG	S12AD.ADDR1
#define RX_210_ADC_ADDR2_REG	S12AD.ADDR2
#define RX_210_ADC_ADDR3_REG	S12AD.ADDR3
#define RX_210_ADC_ADDR4_REG	S12AD.ADDR4
#define RX_210_ADC_ADDR5_REG	S12AD.ADDR5
#define RX_210_ADC_ADDR6_REG	S12AD.ADDR6
#define RX_210_ADC_ADDR7_REG	S12AD.ADDR7
#define RX_210_ADC_ADDR8_REG	S12AD.ADDR8
#define RX_210_ADC_ADDR9_REG	S12AD.ADDR9
#define RX_210_ADC_ADDR10_REG	S12AD.ADDR10
#define RX_210_ADC_ADDR11_REG	S12AD.ADDR11
#define RX_210_ADC_ADDR12_REG	S12AD.ADDR12
#define RX_210_ADC_ADDR13_REG	S12AD.ADDR13
#define RX_210_ADC_ADDR14_REG	S12AD.ADDR14
#define RX_210_ADC_ADDR15_REG	S12AD.ADDR15
#define _HAL_RX210_ADC_ADDR_REG(channel)	(RX_210_ADC_ADDR##channel##_REG)
/* A/D Data Duplication Register */
#define _HAL_RX210_ADC_ADDBLDR_REG	S12AD.ADDBLDR
/* A/D Temperature Sensor Data register */
#define _HAL_RX210_ADC_ADTSDR_REG	S12AD.ADTSDR
/** A/D Internal Reference Voltage Data Register */
#define _HAL_RX210_ADC_ADOCDR_REG	S12AD.ADOCDR
/** A/D Self Diagnosis Data Register */
#define  _HAL_RX210_ADC_ADRD_REG	S12AD.ADRD.WORD
/** A/D Control Register */
#define _HAL_RX210_ADC_ADCSR_REG	S12AD.ADCSR.WORD
/** A/D Channel Select Register */
#define _HAL_RX210_ADC_ADANSA_REG	S12AD.ADANSA.WORD
/** A/D Channel Select Register B */
#define _HAL_RX210_ADC_ADANSB_REG	S12AD.ADANSB.WORD
/** A/D-Converted Value Addition Mode Select Register*/
#define _HAL_RX210_ADC_ADADS_REG	S12AD.ADADS.WORD
/** A/D-Converted Value Addition Count Select Register */
#define _HAL_RX210_ADC_ADADC_REG	S12AD.ADADC.BYTE
/** A/D Control Extended Register */
#define _HAL_RX210_ADC_ADCER_REG	S12AD.ADCER.WORD
/** A/D Start Trigger Select Register */
#define _HAL_RX210_ADC_ADSTRGR_REG	S12AD.ADSTRGR.WORD
/** A/D Conversion Extended Input Control Register */
#define _HAL_RX210_ADC_ADEXICR_REG	S12AD.ADEXICR.WORD
/** A/D Sampling State Register n */
#define RX_210_ADC_ADDSSTR0_REG	S12AD.ADSSTRO
#define RX_210_ADC_ADDSSTR1_REG	S12AD.ADSSTR1
#define RX_210_ADC_ADDSSTR2_REG	S12AD.ADSSTR2
#define RX_210_ADC_ADDSSTR3_REG	S12AD.ADSSTR3
#define RX_210_ADC_ADDSSTR4_REG	S12AD.ADSSTR4
#define RX_210_ADC_ADDSSTR5_REG	S12AD.ADSSTR5
#define RX_210_ADC_ADDSSTR6_REG	S12AD.ADSSTR6
#define RX_210_ADC_ADDSSTR7_REG	S12AD.ADSSTR7
#define _HAL_RX210_ADC_ADDSSTR_REG(channel)	(RX_210_ADC_ADDSSTR##channel##_REG)	/* n=1-7*/
#define _HAL_RX210_ADC_ADDSSTRL_REG	S12AD.ADSSTRL.
#define _HAL_RX210_ADC_ADDSSTRT_REG	S12AD.ADSSTRT
#define _HAL_RX210_ADC_ADDSSTRO_REG	S12AD.ADSSTRO
/** A/D Sample and Hold Circuit Control Register */
#define _HAL_RX210_ADC_ADSHCR_REG	S12AD.ADSHCR.WORD
/** A/D Disconnecting Detection Control Register */
#define _HAL_RX210_ADC_ADDISCR_REG	S12AD.ADDISCR.BYTE
 ...
 */
#define ADC_DisconnectingDetection(mode,time) {S12AD.ADDISCR.BYTE = (((uint8_t)mode << 4) | (uint8_t)time);}
 ...
 * Note:
 */
#define ADC_IsConversionCompleteA()		       ((_HAL_RX210_ADC_ADCSR_REG & 0x8000))
/*
...
#define ADC_EnableInterruptA()					{\
	...
	_HAL_RX210_ADC_ADCSR_REG |= 0x1000;\
...
#define ADC_DisableInterruptA()  		        {\
	ICU.IER[S12AD_ENABLE_VECTOR].BYTE &= ~(1<<6);\
	_HAL_RX210_ADC_ADCSR_REG &= 0xEFFF;\
 ...
 * Note:
 */
#define ADC_EnableInterruptB()  		        {_HAL_RX210_ADC_ADCSR_REG |= 0x0040;}
 ...
 * Note:
 */
#define ADC_DisableInterruptB()  		        {_HAL_RX210_ADC_ADCSR_REG &= 0xFFBF;}
 ...
 * Note
 */
#define ADC_ContinuesConversionA()				{_HAL_RX210_ADC_ADCSR_REG |= 0x4000; _HAL_RX210_ADC_ADCSR_REG &= 0xDFFF;}
 ...
 * Note:
 */
#define ADC_SingleConversionA()  		        {_HAL_RX210_ADC_ADCSR_REG &= 0x9FFF;}
 ...
 * Note:
 */
#define ADC_SelectChannelA(channel)  		    {(_HAL_RX210_ADC_ADANSA_REG = (1<<channel));}
 ...
 * Note:
 */
#define ADC_AddChannelA(channel)  		    	{(_HAL_RX210_ADC_ADANSA_REG |= (1<<channel));}
 ...
 * Note:
 */
#define ADC_RemoveChannelA(channel)  			{(_HAL_RX210_ADC_ADANSA_REG &= ~(1<<channel));}
 ...
 * Note:
 */
#define ADC_SelectChannelB(channel)  		    {(_HAL_RX210_ADC_ADANSB_REG = (1<<channel));}
 ...
 * Note:
 */
#define ADC_AddChannelB(channel)  		    	{(_HAL_RX210_ADC_ADANSB_REG |= (1<<channel));}
 ...
 * Note:
 */
#define ADC_RemoveChannelB(channel)  			{(_HAL_RX210_ADC_ADANSB_REG &= ~(1<<channel));}
 ...
 * Note:
 */
#define ADC_ReadChannelA()  		            _HAL_RX210_ADC_ADANSA_REG
 ...
 * Note:
 */
#define ADC_ReadChannelB()  		            _HAL_RX210_ADC_ADANSB_REG
 ...
 *  Note:
 */
#define ADC_DisableChannelA()					{(_HAL_RX210_ADC_ADANSA_REG = 0x0000);}
 ...
 *  Note:
 */
#define ADC_DisableChannelB()					{(_HAL_RX210_ADC_ADANSB_REG = 0x0000);}
 ...
 * Note:
 */
#define ADC_IsConversionActive()  		       (_HAL_RX210_ADC_ADCSR_REG & 0x8000)
 ...
 * Status:
 */
#define ADC_StartNow()							{_HAL_RX210_ADC_ADCSR_REG |= 0x8000;}
 ...
 * Status: Test me
 */
#define ADC_SetHWTrigger()        		        {_HAL_RX210_ADC_ADCSR_REG |= 0x0300;_HAL_RX210_ADC_ADSTRGR_REG &=F0FF}
/*
 ...
 * Status:
 */
#define ADC_SetSWTrigger()        		        {_HAL_RX210_ADC_ADCSR_REG &= 0xFCFF;} /* TODO: prima era così: _HAL_RX210_ADC_ADCSR_REG |= 0x0200;*/
 ...
 * Status: Not Implemented in RX210
 */
#define ADC_SetHighSpeedConversion()            /* Not implemented in RX210 TODO: remove?*/
 ...
 * Status: Not implemented in RX210
 */
#define ADC_SetLongSampleTime()                 {}		/* TODO: remove?*/
 ...
 * Status: Not supported in RX210
 */
#define ADC_SetBusClockDiv2()				/* TODO: remove?*/
...
#define RX210_IRQ0_PH1		0	/* IRQ0 	Pin23	PH1*/
#define RX210_IRQ1_PH2		1	/* IRQ1 	Pin22	PH2*/
#define RX210_IRQ5_P15		2	/* IRQ5	Pin19	P15*/
#define RX210_IRQ6_PA3		3	/* IRQ6 	Pin43	PA3*/
#define RX210_ELCIRQ0_PB0	4	/* ELCIRQ0 Pin39	PB0*/
#define RX210_ELCIRQ5_PB5	5	/* ELCIRQ5 Pin35	PB5*/
#define RX210_ELCIRQ6_PB6	6	/* ELCIRQ6 Pin34	PB6*/
#define RX210_IRQ_PB1		7	/* TO configure*/
#define RX210_IRQ_PB3		8	/* TO configure*/
#define RX210_IRQ_PB7		9	/* TO configure*/

#define _HAL_RX210_PH1_PORT_PIN_AS_IRQ0		MPC.PH1PFS.BYTE |= 0x40
#define _HAL_RX210_PH2_PORT_PIN_AS_IRQ1		MPC.PH2PFS.BYTE |= 0x40
#define _HAL_RX210_P15_PORT_PIN_AS_IRQ5		MPC.P15PFS.BYTE |= 0x40
#define _HAL_RX210_PA3_PORT_PIN_AS_IRQ6		MPC.PA3PFS.BYTE |= 0x40
#define _HAL_RX210_PH1_PORT_PIN_AS_IO		{DISABLE_PORT_REGISTER_WRITE_PROTECTION();MPC.PH1PFS.BYTE = 0x00;ENABLE_PORT_REGISTER_WRITE_PROTECTION();}
#define _HAL_RX210_PH2_PORT_PIN_AS_IO		{DISABLE_PORT_REGISTER_WRITE_PROTECTION();MPC.PH2PFS.BYTE = 0x00;ENABLE_PORT_REGISTER_WRITE_PROTECTION();}
#define _HAL_RX210_P15_PORT_PIN_AS_IO		{DISABLE_PORT_REGISTER_WRITE_PROTECTION();MPC.P15PFS.BYTE = 0x00;ENABLE_PORT_REGISTER_WRITE_PROTECTION();}
#define _HAL_RX210_PA3_PORT_PIN_AS_IO		{DISABLE_PORT_REGISTER_WRITE_PROTECTION();MPC.PA3PFS.BYTE = 0x00;ENABLE_PORT_REGISTER_WRITE_PROTECTION();}

#define _HAL_RX210_DETECTION_SENSE_LOW_LEVEL 		0x00
#define _HAL_RX210_DETECTION_SENSE_FALLING_EDGE 	0x04
#define _HAL_RX210_DETECTION_SENSE_RAISING_EDGE 	0x08
#define _HAL_RX210_DETECTION_SENSE_BOTH_EDGE 		0x0C	/*Rising and falling edges*/
#define _HAL_RX210_DETECTION_SENSE_ELC_FALLING_EDGE 0x01	/*IRQ detect for ELC module*/
#define _HAL_RX210_DETECTION_SENSE_ELC_RAISING_EDGE 0x00	/*IRQ detect for ELC module*/


/* Interrupt Request Register */
#define _HAL_RX210_IRQ_INTERRUPT_REQUEST_REGISTER(vector)		ICU.IR[vector].BYTE
/* IRQ Control Register */
#define _HAL_RX210_IRQ_CONTROL_REGISTER(irq)					ICU.IRQCR[irq].BYTE

/* Interrupt Request Enable Register */
#define _HAL_RX210_INTERRUPT_REQUEST_ENABLE_REGISTER(ier)	ICU.IER[ier].BYTE
/* Digital Filter Enable Register*/
#define _HAL_RX210_DIGITAL_FILTER_ENABLE_REGISTER	ICU.IRQFLTE0.BYTE

#define _HAL_RX210_ICU_IPR(vector)			ICU.IPR[vector].BYTE
#define _HAL_RX210_ICU_IRQ_IER_REGISTER		8

/* IRQ0*/
#define IRQ0								0
#define _HAL_RX210_ICU_IRQ0_VECTOR			64
#define _HAL_RX210_ICU_IRQ0_IER_MASK		(1<<0)
#define IRQ0_INTERRUPT_PRIORITY				0x01
#define IRQ0_DIGITAL_FILTER_MASK			(1<<0)
/* IRQ1*/
#define IRQ1								1
#define _HAL_RX210_ICU_IRQ1_VECTOR			65
#define _HAL_RX210_ICU_IRQ1_IER_MASK		(1<<1)
#define IRQ1_INTERRUPT_PRIORITY				0x01
#define IRQ1_DIGITAL_FILTER_MASK			(1<<1)
/* IRQ5*/
#define IRQ5								5
#define _HAL_RX210_ICU_IRQ5_VECTOR			69
#define _HAL_RX210_ICU_IRQ5_IER_MASK		(1<<5)
#define IRQ5_INTERRUPT_PRIORITY				0x01
#define IRQ5_DIGITAL_FILTER_MASK			(1<<5)
/* IRQ6*/
#define IRQ6								6
#define _HAL_RX210_ICU_IRQ6_VECTOR			70
#define _HAL_RX210_ICU_IRQ6_IER_MASK		(1<<6)
...
#define _HAL_RX210_ICU_ELC_ELSR18L_VECTOR	106
#define _HAL_RX210_ICU_ELC_ELSR19L_VECTOR	107
#define _HAL_RX210_ICU_ELC_IER_REGISTER		13
#define _HAL_RX210_ICU_ELC_ELSR18L_IER_MASK	(1<<2)
#define _HAL_RX210_ICU_ELC_ELSR19L_IER_MASK	(1<<3)
...
#define _HAL_RX210_CRC_CONTROL_REGISTER			CRC.CRCCR.BYTE
...
#define _HAL_RX210_CRC_DATA_INPUT_REGISTER		CRC.CRCDIR
/* CRC Data Output Register */
#define _HAL_RX210_CRC_DATA_OUTPUT_REGISTER		CRC.CRCDOR
...
#define CRC_ClockGateOn(){\
		DISABLE_REGISTER_WRITE_PROTECTION;\
		_HAL_RX210_MODULE_STOP_CONTROL_1_REGISTER_B &= ~CRC_LOW_POWER_MASK;\
		ENABLE_REGISTER_WRITE_PROTECTION;\
}/*end CRC_ClockGateOn*/
...
#define InitCRCmodule(){\
	CRC_ClockGateOn();\
	_HAL_RX210_CRC_CONTROL_REGISTER |= BIT_CRC_MASK_16;\
	_HAL_RX210_CRC_CONTROL_REGISTER |= BIT_CRC_LMS_MASK;\
	_HAL_RX210_CRC_CONTROL_REGISTER |= DORCLR_CRC_BIT_MASK;\
	_HAL_RX210_CRC_DATA_OUTPUT_REGISTER = 0;\
}/*end InitCRCmoudule*/
#define DeInitCRCmodule(){\
	_HAL_RX210_CRC_CONTROL_REGISTER &= 0x00;\
	_HAL_RX210_CRC_CONTROL_REGISTER &= 0x00;\
}
...
#define InitCRC(seed)		{\
	...
	_HAL_RX210_CRC_CONTROL_REGISTER |= BIT_CRC_LMS_MASK;\
	_HAL_RX210_CRC_CONTROL_REGISTER |= DORCLR_CRC_BIT_MASK;\
	_HAL_RX210_CRC_DATA_OUTPUT_REGISTER = seed;\
}

#define ComputeCRC(data){\
		_HAL_RX210_CRC_DATA_INPUT_REGISTER = data;\
}/*end ComputeCRC*/
#define GetFinalCRC()	_HAL_RX210_CRC_DATA_OUTPUT_REGISTER
...
#define _HAL_RX210_DMA_SOURCE_ADDRESS_REGISTER(n)	DMAC##n##_SOURCE_ADDRESS_REGISTER
...
#define _HAL_RX210_DMA_DESTINATION_ADDRESS_REGISTER(n)	DMAC##n##_DESTINATION_ADDRESS_REGISTER
...
#define _HAL_RX210_DMA_TRANSFER_COUNT_REGISTER(n)	DMAC##n##_TRANSFER_COUNT_REGISTER
...
#define _HAL_RX210_DMA_BLOCK_TRANSFER_COUNT_REGISTER(n)	DMAC##n##_BLOCK_TRANSFER_COUNT_REGISTER
...
#define _HAL_RX210_DMA_TRANSFER_MODE_REGISTER(n)	DMAC##n##_TRANSFER_MODE_REGISTER
...
#define _HAL_RX210_DMA_ICU_ACTIVATION_REGISTER(n)	DMAC##n##_ICU_ACTIVATION_REGISTER
...
#define _HAL_RX210_DMA_INTERRUPT_SETTING_REGISTER(n)	DMAC##n##_INTERRUPT_SETTING_REGISTER
...
#define _HAL_RX210_DMA_ADDRESS_MODE_REGISTER(n)	DMAC##n##_ADDRESS_MODE_REGISTER
/* DMA Offset Register*/
...
#define _HAL_RX210_DMA_OFFSET_REGISTER(n)	DMAC##n##_OFFSET_REGISTER
...
#define _HAL_RX210_DMA_TRANSFER_ENABLE_REGISTER(n)	DMAC##n##_TRANSFER_ENABLE_REGISTER
...
#define _HAL_RX210_DMA_SOFTWARE_START_REGISTER(n)	DMAC##n##_SOFTWARE_START_REGISTER
/* DMA Status Register*/
...
#define _HAL_RX210_DMA_STATUS_REGISTER(n)	DMAC##n##_STATUS_REGISTER
...
#define _HAL_RX210_DMA_ACTIVATION_SOURCE_FLAG_CONTROL_REGISTER(n)	DMAC##n##_ACTIVATION_SOURCE_FLAG_CONTROL_REGISTER
/* DMA Module Activation Register*/
#define _HAL_RX210_DMA_MODULE_ACTIVATION_REGISTER_ENABLE	DMAC.DMAST.BIT.DMST = 1
#define _HAL_RX210_DMA_MODULE_ACTIVATION_REGISTER_DISABLE	DMAC.DMAST.BIT.DMST = 0
...
#define _HAL_RX210_DMAC_ACTIVATION_REQUEST_SELECT_REGISTER(n)	DMAC_ACTIVATION_REQUEST_SELECT_REGISTER_##n##_
...
#define _HAL_RX210_SPI_IPR_REG 	ICU.IPR[SPI_INT_PRIORITY_VECT].BYTE
#define _HAL_RX210_SPI_IER_REG  ICU.IER[SPI_INT_IER].BYTE
/*RX*/
#define SPI_RX_INTERRUPT_ENABLE		TRUE
#define SPI_RX_INT_VECT				45
#define _HAL_RX210_SPI_RX_IR       	ICU.IR[SPI_RX_INT_VECT].BYTE
...
#define _HAL_RX210_SPI_TX_IR       	ICU.IR[SPI_TX_INT_VECT].BYTE
/**/
/**/
/* SS Polarity */
...
#define PDL_LPM_OPC_MIDDLE_SPEED_1A			0x02
#define PDL_LPM_OPC_LOW_SPEED_1				0x06
#define PDL_LPM_OPC_LOW_SPEED_2				0x07

/* LOW Power Mode */
#define LPM_AllClockOff()\
{\
	DISABLE_REGISTER_WRITE_PROTECTION;\
	SYSTEM.MSTPCRA.LONG = 0x7FFFFFFF;	/*All-Module Clock Stop Mode Enable (ACSE) = 0 (not enabled) */\
	SYSTEM.MSTPCRB.LONG = 0xFFFFFFFF;\
	SYSTEM.MSTPCRC.LONG = 0xFFFFFFFE;	/*RAM0 Module Stop (MSTPC0) = 0 (operating) */\
	ENABLE_REGISTER_WRITE_PROTECTION;\
}

#define LPM_SleepModeInit()

/* Functions prototype */
void LPM_SleepModeProc(void);

/* additional features */
#define LPM_IsTimerExpired()	1
#define LPM_WakeupTimerClearFlag()

/* ********************************************************************************************** */
/*                                  LPM LVD Class HAL Support                                   */
/* ********************************************************************************************** */

#endif	/*  end file RN_RX210_R5F2108_hal.h */
/* ********************************************************************************************** */
/*                                  END OF FILE 												  */
/* ********************************************************************************************** */
