 ...
 *
 *      Modified by Stefano Ughi compare with default ver. for changes
 */
...
asm __declspec(register_abi) void __ram_initialization(void);
...
extern void __lib_reset_manager(void);
...
/*
Purpuse:    - clear .bss and .sbss sections
            - init .data section
...
__skip_bss__:
    ...
    .sbss specifies an uninitialized read-write data section maximum size 64K */
    lea           _END_SBSS, a0
    lea           _START_SBSS, a1
    suba.l        a1, a0
    move.l        a0, d0
...
asm __declspec(register_abi) void _startup(void)
{
	...
	*/
	lea __SP_AFTER_RESET,a7;    /* __SP_AFTER_RESET defined inside .lcf */
    ...
    lea           _SP_INIT,a7   /* _SP_INIT defined inside .lcf */
        
	/* setup A6 dummy stackframe */
    movea.l       #0,a6
    link          a6,#0           /* SP-4 -> SP; Ay -> (SP); SP -> Ay; SP + dn -> SP */ 

	/* setup A5 */
    lea           _SDA_BASE,a5
        
    jsr           __lib_reset_manager

	jsr		  	  __initialize_system
    
	/* call main(int, char **) */
	pea			  __argv            /* SP - 4 -> SP; <ea>y -> (SP) */
